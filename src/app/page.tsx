...
export default function Home() {
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <div className="animate-fade-in-up">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-teal/30 text-sm text-teal-accent mb-8 font-sans">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-in-up-delay-2 font-sans">
            ...
            your operations &mdash; so you can scale without hiring.
          </p>
          ...
          <p className="text-gray-500 text-sm mt-8 font-sans animate-fade-in-up-delay-3 flex items-center justify-center gap-2">
            <span className="flex -space-x-2">
              {[0, 1, 2, 3].map((i) => (
                <span
                  key={i}
                  className="w-6 h-6 rounded-full bg-gradient-to-br from-teal to-teal-accent border-2 border-navy inline-block"
                />
              ))}
            </span>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-navy rounded-2xl p-8 text-white">
              ...
              <h3 className="font-heading text-xl font-semibold mb-3">Missed Calls = Missed Revenue</h3>
            ...
            <div className="bg-navy rounded-2xl p-8 text-white">
              ...
              <h3 className="font-heading text-xl font-semibold mb-3">Manual Follow-ups Burn Hours</h3>
              <p className="text-gray-300 leading-relaxed font-sans">
            ...
            <div className="bg-navy rounded-2xl p-8 text-white">
              ...
              <h3 className="font-heading text-xl font-semibold mb-3">Leads Go Cold While You Sleep</h3>
              <p className="text-gray-300 leading-relaxed font-sans">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto font-sans">
              Every solution we build is designed to generate more revenue than it costs &mdash;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="group relative bg-white/[0.03] border border-white/[0.06] rounded-2xl p-8 hover:bg-white/[0.06] hover:border-teal/20 transition-all duration-300">
              ...
              <p className="text-gray-500 leading-relaxed font-sans mb-4">
                ...
                appointments, and routes urgent calls to you &mdash; in a natural, human-like voice.
              </p>
            ...
            <div className="group relative bg-white/[0.03] border border-white/[0.06] rounded-2xl p-8 hover:bg-white/[0.06] hover:border-teal/20 transition-all duration-300">
              ...
              <p className="text-gray-500 leading-relaxed font-sans mb-4">
                ...
                questions, qualify leads, and book meetings &mdash; all while you sleep.
              </p>
              <span className="text-teal text-sm font-sans font-medium group-hover:underline">
                Learn more &rarr;
              </span>
            ...
            <div className="group relative bg-white/[0.03] border border-white/[0.06] rounded-2xl p-8 hover:bg-white/[0.06] hover:border-teal/20 transition-all duration-300">
              ...
              <p className="text-gray-500 leading-relaxed font-sans mb-4">
                Smart funnels that don&apos;t just capture leads &mdash; they qualify them. Know
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div className="relative text-center">
              ...
              <p className="text-gray-500 leading-relaxed font-sans">
                We design and build your AI systems from scratch &mdash; tailored to your business,
      ...
      {/* 6. RESULTS SECTION */}
      <section id="results" className="relative py-24 md:py-32 bg-gradient-to-b from-navy via-deep-blue to-navy">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <p className="text-teal text-sm font-semibold uppercase tracking-widest mb-3 font-sans">
              Results
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            <div className="text-center p-6 md:p-8 rounded-2xl bg-white/[0.03] border border-white/[0.06]">
              <div className="font-heading text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-teal to-teal-accent mb-2">
                40%
              </div>
              <p className="text-gray-500 font-sans text-sm md:text-base">
                of calls missed by the average business &mdash; ours miss zero
              </p>
            </div>
            <div className="text-center p-6 md:p-8 rounded-2xl bg-white/[0.03] border border-white/[0.06]">
              <div className="font-heading text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-teal to-teal-accent mb-2">
            ...
            <div className="text-center p-6 md:p-8 rounded-2xl bg-white/[0.03] border border-white/[0.06]">
              ...
              <p className="text-gray-500 font-sans text-sm md:text-base">
                your AI works around the clock &mdash; no sick days, no breaks
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-8 rounded-2xl bg-white/[0.03] border border-white/[0.06]">
              ...
              <div>
                <p className="font-heading font-semibold">Coming soon</p>
      ...
      {/* 8. FINAL CTA SECTION */}
      <section className="relative py-24 md:py-32 bg-gradient-to-b from-navy to-deep-blue overflow-hidden">
        <div
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mt-8 pt-8 border-t border-white/5 flex flex-col items-center gap-1">
            <p className="text-gray-500 text-sm font-sans">
              &copy; 2026 wirig.ai &mdash; All rights reserved.
            </p>
